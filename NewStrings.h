...
String * AppendString__(String * des,char src){
    SET_STRING_ERROR(0);
    if(des==NULL)
    {
        des=NewString(1);
...
String * AppendString_(String * des,char *src){
    SET_STRING_ERROR(0);
...
String *ReadLine(){
    String *str=NewString(MAX_STRING_LEN);
    fgets(str->data,MAX_STRING_LEN-1, stdin);
